function fit = ModelFitFunc_FixedOmega_AllE(unks, select, groupNum, Theta, ThetaTot, Hstates, year, Data_full, omeg1to5)
% ModelFitFunc_FixedOmega_AllE — Negative log-likelihood for fixed-omega estimation
%
% Phase 3 objective: Theta=4 non-polar types + 1 polar (All-N).
% All-E (type Theta) has structural zeros on state 3.
% Omegas are fixed (loaded externally), only transition matrices estimated.
%
% Based on ModelFitFuncTimeSeriesFixedOmega_NewTrMBoot_AllE_V3.m (Sep 2025)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Regularization: encourage type separation
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

m  = 0.02;    % margin (type separation threshold)
lam = 2.0;    % penalty weight (zero at correct ordering, dominates likelihood gain from swapping)
tau = 0.05;   % softplus smoothing (smooth gradient transition near boundary)
t2 = 1; t3 = 2; t4 = 3;
