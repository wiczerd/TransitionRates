function fit = ModelFitFunc_FixedOmega_AllE_NoReg(unks, select, groupNum, Theta, ThetaTot, Hstates, year, Data_full, omeg1to5)
...
m  = 5e-3;    % margin
lam = 0;   % per-observation weight
tau = 1e-3;   % softplus smoothing
t2 = 1; t3 = 2; t4 = 3;
